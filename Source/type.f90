...
TYPE SURFACE_TYPE
   ...
   !IBMB parameter
   LOGICAL :: IBMB_SF, MFLUX, INNER_BC
   REAL(EB) :: TEMPERATURE_BC,HEAT_FLUX_BC,THERM_CONTACT_R
   !IBMB parameter
...
TYPE OBSTRUCTION_TYPE
   ...
   INTEGER :: NUM_XX,NUM_YY,NUM_ZZ,MATL_DEF
   INTEGER :: NUM_OB_XX,NUM_OB_YY,NUM_OB_ZZ
   INTEGER :: STEPCOUNT_ITERATE
   INTEGER :: N_IBMB_WALL_CELLS,OB_NR
   REAL(EB) :: DT_OUTPUT,OUTPUT_CLOCK
   REAL(EB) :: DELTA_X,DELTA_Y,DELTA_Z
   REAL(EB) :: NUM_MFLUX = 0._EB
   REAL(EB) :: EPS_TOL,FLUX_LIMITER
   REAL(EB) :: SUBCELL_TO_MESHCELL_XX,SUBCELL_TO_MESHCELL_YY,SUBCELL_TO_MESHCELL_ZZ
   REAL(EB), DIMENSION(6) :: MFLUX_A_FAC = 0._EB !six faces E,W,N,S,T,B
   REAL(EB), DIMENSION(3) :: MFLUX_XYZ = 0._EB
   
   INTEGER, ALLOCATABLE, DIMENSION(:,:,:) :: IBMB_COMP
   INTEGER, ALLOCATABLE, DIMENSION(:) :: IW_IBMB
   
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: TMP_ITERATE_2
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: TMP_ITERATE
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: TMP
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: K_S
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: C_S
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: Q_S

   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: DT_MAX_STABLE
   
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: REACTION_RATE
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: RHO_IBMB !steht schon in 3D-pyrolysis
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: RHO_0
   
   ! Shrinking and Swelling
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: REGRID_FACTOR
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: REGRID_FACTOR_PROD
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: DEL_X
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: DEL_Y
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: DEL_Z
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: SUBCELL_VOLUME
   
   ! Solid phase density
   ! X,Y,Z,N_MATL
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: RHO_N
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: RR
   
   ! Solid phase fractions
   ! X,Y,Z,N_MATL
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: Y_S
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: X_S
   
   ! MASS of solid and gaseous components in solid phase pore system
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: MASS_SOLID
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: MASSFLUX
...
TYPE COMPOUND_TYPE
    !General parameter
    !N_MATL
    CHARACTER(30), ALLOCATABLE, DIMENSION(:) :: MATL_ID
    
    !N_TRACKED_SPECIES
    REAL(EB), ALLOCATABLE, DIMENSION(:) :: SPEC_MASS
    !N_MATL
    REAL(EB), ALLOCATABLE, DIMENSION(:) :: RHO_0
    REAL(EB), ALLOCATABLE, DIMENSION(:) :: K_S
    REAL(EB), ALLOCATABLE, DIMENSION(:) :: C_S
    ...
    REAL(EB), ALLOCATABLE, DIMENSION(:) :: X_S
    !N_TRACKED_SPECIES
    REAL(EB), ALLOCATABLE, DIMENSION(:) :: Y_GS
    
    !N_MATL
    INTEGER, ALLOCATABLE, DIMENSION(:) :: MATL_INDEX
    INTEGER :: MATL_NUM
...
TYPE(COMPOUND_TYPE),DIMENSION(:), ALLOCATABLE, TARGET :: COMPOUND
! IBMB type end
